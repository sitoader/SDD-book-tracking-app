...
export default function BookTrackerBooksListingPageWrapper(): React.JSX.Element {
  return (
    <Suspense>
      <BookTrackerBooksListingPage />
    </Suspense>
  );
}

function BookTrackerBooksListingPage(): React.JSX.Element {
